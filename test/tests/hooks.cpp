...
namespace hook_test
{
  ...
  template <class T> constexpr inline void hook_result_construction(BOOST_OUTCOME_V2_NAMESPACE::in_place_type_t<T>, result<int> *res) noexcept
  {
  ...
  template <class T> constexpr inline void hook_result_construction(BOOST_OUTCOME_V2_NAMESPACE::in_place_type_t<T>, result<std::string> *res) noexcept
  {
    // Write the value in the result into the static storage
...
namespace hook_test
{
  ...
  template <class T, class R> constexpr inline void hook_outcome_copy_construction(BOOST_OUTCOME_V2_NAMESPACE::in_place_type_t<const result<T> &>, outcome<R> *res) noexcept
  {
  ...
  template <class T, class R> constexpr inline void hook_outcome_move_construction(BOOST_OUTCOME_V2_NAMESPACE::in_place_type_t<result<T> &&>, outcome<R> *res) noexcept
  {
