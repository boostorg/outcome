...
#else
#include <cstdlib>  // for abort
#ifndef BOOST_OUTCOME_SYSTEM_ERROR2_AVOID_STDIO_INCLUDE
#ifdef __APPLE__
#define BOOST_OUTCOME_SYSTEM_ERROR2_AVOID_STDIO_INCLUDE 0
#else
#define BOOST_OUTCOME_SYSTEM_ERROR2_AVOID_STDIO_INCLUDE 1
#endif
#endif
