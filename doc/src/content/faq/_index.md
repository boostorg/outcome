...
#define BOOST_OUTCOME_DETERMINISTIC_EXCEPTIONS_USE_EMULATION 1
...
#define BOOST_OUTCOME_THROWS_API(rettype, errtype, ...) ::BOOST_OUTCOME_V2_NAMESPACE::experimental::status_result<rettype, errtype> __VA_ARGS__ noexcept
#else
#define BOOST_OUTCOME_THROWS_API(rettype, errtype, ...) rettype __VA_ARGS__ throws(errtype)
#endif
...
*/
#if BOOST_OUTCOME_DETERMINISTIC_EXCEPTIONS_USE_EMULATION
#define BOOST_OUTCOME_THROWS_ERROR_API(rettype, ...) ::BOOST_OUTCOME_V2_NAMESPACE::experimental::status_result<rettype, ::BOOST_OUTCOME_SYSTEM_ERROR2_NAMESPACE::error> __VA_ARGS__ noexcept
#else
...
*/
#if BOOST_OUTCOME_DETERMINISTIC_EXCEPTIONS_USE_EMULATION
#define BOOST_OUTCOME_THROW(...) return ::BOOST_OUTCOME_V2_NAMESPACE::failure(__VA_ARGS__)
#else
#define BOOST_OUTCOME_THROW(...) throw(__VA_ARGS__)
#endif

/*! Call an API. Will compile into deterministic exceptions, or an emulation.
*/
#if BOOST_OUTCOME_DETERMINISTIC_EXCEPTIONS_USE_EMULATION
#define BOOST_OUTCOME_CALL_API(...) BOOST_OUTCOME_TRY(...)
#else
#define BOOST_OUTCOME_CALL_API(...) (__VA_ARGS__)
#endif
...
*/
#if BOOST_OUTCOME_DETERMINISTIC_EXCEPTIONS_USE_EMULATION
#define BOOST_OUTCOME_CATCH_EXPR(...) (...)
#else
#define BOOST_OUTCOME_CATCH_EXPR(...) catch(__VA_ARGS__)
#endif
```
...
...
int v = BOOST_OUTCOME_CALL_API(foo(5.0));
```
